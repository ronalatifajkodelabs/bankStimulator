...
//                    .registerTypeAdapter(LocalDateTime.class, new BankAccountDB.LocalDateTimeDeserializer())
//                    .create();
//
//            // Read the JSON array from the file into a FileReader
//            FileReader reader = new FileReader("src/jsonFiles/bankAccounts.json");
//
//            // Define the type of the collection
//            Type bankAccountListType = new TypeToken<ArrayList<BankAccount>>() {
//            }.getType();
//
//            // Parse the JSON array into a list of BankAccount objects
//            List<BankAccount> bankAccountsRead = gson.fromJson(reader, bankAccountListType);
//
//            // Close the reader
//            reader.close();
...
//                    "Account Holder: " + bankAccount.getAccountHolder().getFirstName() + " " + bankAccount.getAccountHolder().getLastName()
//                    + ", " + "Account Balance: " + bankAccount.getBalanceAmount() + ", " + "Account Type: " + bankAccount.getAccountType());
//            if (bankAccount.getAccountType() == AccountType.SAVINGS) {
//                System.out.print(", Minimum balance: " + bankAccount.getMinimumBalance());
//            }
//            System.out.println();
//        });
//    }
